...
sim.figarch <- ugarchsim(fit.figarch, n.sim = 6118, m.sim = 10000)

G <- sim.figarch@simulation[["seriesSim"]]
...
percentis <- c(.5, 2.5, 5, 25, 50, 75, 95, 97.5, 99.5)/100
